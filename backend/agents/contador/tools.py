...
_CATALOGO: list[dict] = [
    {
        ...
        "description": (
            "Catálogo completo de cuentas de RODDOS en Alegra. Solo lectura — NO consulta nada, "
            "el catálogo está embebido aquí para referencia inmediata del LLM.\n\n"
            "GASTOS:\n"
            "- 5462: Sueldos 510506 (Personal/Salarios)\n"
            "- 5470: Honorarios (Personal/Honorarios)\n"
            "- 5471: Seguridad Social (Personal/Seguridad_Social)\n"
            "- 5472: Dotaciones (Personal/Dotacion)\n"
            "- 5480: Arrendamientos 512010 (Operaciones/Arriendo)\n"
            "- 5484: Servicios Públicos (Operaciones/Servicios_Publicos)\n"
            "- 5487: Teléfono/Internet 513535 (Operaciones/Telefonia)\n"
            "- 5490: Mantenimiento (Operaciones/Mantenimiento)\n"
            "- 5491: Transporte (Operaciones/Transporte)\n"
            "- 5493: Gastos Generales — FALLBACK (Otros/Varios) — NUNCA usar 5495\n"
            "- 5497: Útiles Papelería 519530 (Operaciones/Papeleria)\n"
            "- 5500: Publicidad (Marketing/Publicidad)\n"
            "- 5501: Eventos (Marketing/Eventos)\n"
            "- 5505: ICA (Impuestos/ICA)\n"
            "- 5508: Comisiones Bancarias 530515 (Financiero/Comisiones)\n"
            "- 5510: Seguros (Financiero/Seguros)\n"
            "- 5533: Intereses 615020 (Financiero/Intereses)\n\n"
            "RETENCIONES:\n"
            "- 236505: ReteFuente practicada\n"
            "- 236560: ReteICA practicada\n\n"
            "BANCOS:\n"
            "- 111005: Bancolombia\n"
            "- 111010: BBVA\n"
            "- 111015: Davivienda\n"
            "- 111020: Banco de Bogotá\n"
            "- 11100507: Global66\n\n"
            "RETENCIONES 2026:\n"
            ...
            "- Auteco NIT 860024781: autoretenedor — NUNCA ReteFuente\n\n"
            "SOCIOS (gastos personales = CXC, NUNCA gasto operativo):\n"
