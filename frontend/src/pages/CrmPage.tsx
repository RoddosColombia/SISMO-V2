                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-surface-container-low">
                      ...
                      <th className="text-left px-4 py-2.5 text-xs text-on-surface-variant font-medium">Cedula</th>
                      <th className="text-left px-4 py-2.5 text-xs text-on-surface-variant font-medium">Telefono</th>
                      <th className="text-center px-4 py-2.5 text-xs text-on-surface-variant font-medium">Estado</th>
                      <th className="text-right px-4 py-2.5 text-xs text-on-surface-variant font-medium">Creditos</th>
                    </tr>
                  </thead>
                  <tbody>
                    {filtered.map(c => (
                      <tr key={c.cedula} className="border-t border-surface-container-low hover:bg-surface-container-low/40 transition-colors">
